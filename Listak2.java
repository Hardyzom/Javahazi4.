...
class Listak2
{
    ...
    private static List<Integer> removeAdjacent(List<Integer> nums)
    {
        ...
        result.add(nums.get(0));  // Add the first element to the result list.
        
        // Iterate through the list and add elements to the result if they are different from the previous one.
    ...
    private static List<String> listMerge(List<String> li1, List<String> li2)
    {
        ...
        // Merge the two sorted lists while maintaining the sorted order.
        while (i < li1.size() && j < li2.size()) {
            String str1 = li1.get(i);
            String str2 = li2.get(j);
        ...
        // Add any remaining elements from li1, if any.
        while (i < li1.size()) {
            result.add(li1.get(i));
            i++;
        }
        
        // Add any remaining elements from li2, if any.
        while (j < li2.size()) {
